...
const HowToBuy = () => {
  return (
    ...
    <div className="flex flex-col md:flex-row items-center space-x-0 md:space-x-10 space-y-10 md:space-y-0 justify-center relative">
      ...
      <div className="relative p-6  rounded-xl flex items-center w-1/2 z-20 border-t border-x">
        <div className={`${classes?.bgcolor} absolute inset-0 rounded-lg p-0`} />
        <div className="relative z-40">
          <h2 className="text-5xl font-bold mb-4">How to buy on Uniswap?</h2>
